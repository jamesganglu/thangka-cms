...
export interface ApiBuddhismBuddhism extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    image2: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiHistoryHistory extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event: Schema.Attribute.Component<'events.events', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    history: Schema.Attribute.Component<'histories.histories', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
